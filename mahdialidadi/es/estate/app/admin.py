...
class RentAdmin(ExportMixin,admin.ModelAdmin):
    list_display = ('code','nameM','melktype', 'metraj','phase','priceR','priceE','area','date','status')
...
class SellAdmin(ExportMixin,admin.ModelAdmin):
